...
def test_compare_bmmap_dread(dread_path):
    parse_and_build_compare(
        BMMAP, Game.DREAD, dread_path.joinpath("maps/levels/c10_samus/s010_cave/s010_cave.bmmap"),
    )

def test_compare_bmmdef_dread(dread_path):
    parse_and_build_compare(
        BMMDEF, Game.DREAD, dread_path.joinpath("system/minimap/minimap.bmmdef"),
    )
