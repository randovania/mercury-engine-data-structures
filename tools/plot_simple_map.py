...
_polygon_override = {
    ...
    ("s010_cave", "collision_camera_023"): [[24900.0, 5100.0], [17800.0, 5100.0], [17800.0, 3400.0], [24900.0, 3400.0]],
...
_rooms_for_actors = {
    "s010_cave": {
        ...
        "door_frblack_protoemmy_000": ["collision_camera_016 (A)", "collision_camera_064 (A)"],
        "door_frblack_protoemmy_001": ["collision_camera_064 (A)", "collision_camera_074 (A)"],
        ...
        "doorshieldsupermissile_000": ["collision_camera_011 (A)", "collision_camera_055 (A)"],
    ...
    "s020_magma": {
        ...
        "SP_Checkpoint_Dead_CooldownX": ["collision_camera_009 (C)", "collision_camera_CooldownX (C)"],
        ...
        "TG_PostCoolDownX_MusicChange": ["collision_camera_009 (C)", "collision_camera_CooldownX (C)"],
        ...
        "cooldownxbosslavacarpet": ["collision_camera_009 (C)", "collision_camera_CooldownX (C)"],
        ...
        "door_frblack_gen_001": ["collision_camera_022 (C)", "collision_camera_035 (C)", "collision_camera_036 (C)"],
        ...
        "ev_hpiston_mg_001_off": ["collision_camera_009 (C)", "collision_camera_CooldownX (C)"],
        ...
        "fusiblebox_broken_000": ["collision_camera_009 (C)", "collision_camera_CooldownX (C)"],
        ...
        "mblauncher_exit_gen_002": ["collision_camera_063 (C)", "collision_camera_063_Stage_002 (C)"],
        "mblauncher_exit_gen_003": ["collision_camera_063 (C)", "collision_camera_063_Stage_002 (C)"],
        "mblauncher_launcher_gen_001": ["collision_camera_004 (C)"],
        "mblauncher_launcher_gen_002": ["collision_camera_063 (C)", "collision_camera_063_Stage_002 (C)"],
        "mblauncher_launcher_gen_003": ["collision_camera_063 (C)", "collision_camera_063_Stage_002 (C)"],
    ...
    "s050_forest": {
        ...
        "doorshieldmissile_001": ["collision_camera_024 (G)", "collision_camera_025_B (G)"],
        "doorshieldsupermissile_000": ["collision_camera_001 (G)", "collision_camera_035 (G)"],
        "doorshieldsupermissile_001": ["collision_camera_007 (G)", "collision_camera_029 (G)"],
        "doorshieldsupermissile_002": ["collision_camera_009 (G)", "collision_camera_010 (G)"],
    ...
    "s060_quarantine": {
        "CAM_Default": ["collision_camera_011 (E)"],
        ...
        "TG_QuarentineOpen": ["collision_camera_003 (E)", "collision_camera_MBL_B (E)"],
        ...
        "door_shield_plasma_000": ["collision_camera_002 (E)", "collision_camera_003 (E)"],
        "door_shield_plasma_001": [],
        "door_shield_plasma_002": ["collision_camera_005 (E)", "collision_camera_007 (E)"],
        "door_shield_plasma_004": ["collision_camera_002 (E)", "collision_camera_003 (E)"],
        ...
        "ev_gatesealed_second": ["collision_camera_000 (E)", "collision_camera_002 (E)"],
        ...
        "mblauncher_exit_gen_001": ["collision_camera_003 (E)", "collision_camera_MBL_B (E)"],
        "mblauncher_launcher_gen_000": ["collision_camera_MBL_B (E)"],
        "mblauncher_launcher_gen_001": ["collision_camera_002 (E)"],
        "mblauncher_launcher_gen_002": ["collision_camera_003 (E)", "collision_camera_MBL_B (E)"],
    ...
    "s070_basesanc": {
        ...
        "door_shield_plasma_000": ["collision_camera_018 (F)", "collision_camera_030 (F)"],
        "door_shield_plasma_001": ["collision_camera_018 (F)", "collision_camera_030 (F)"],
        "door_shield_plasma_002": ["collision_camera_007 (F)", "collision_camera_010 (F)"],
        "door_shield_plasma_003": ["collision_camera_007 (F)", "collision_camera_010 (F)"],
        ...
        "doorgrapplegrapple_000": ["collision_camera_018 (F)", "collision_camera_030 (F)"],
        ...
        "doorshieldmissile_000": ["collision_camera_012 (F)", "collision_camera_015 (F)"],
...
def create_door_nodes_for_actor(
    ...
    simple = {"def": details.actor_def, "left": extra.get("left_shield_def"), "right": extra.get("right_shield_def")}
...
def decode_world(  # noqa: C901
    ...
    target_level: str,
    out_path: Path,
    only_update_existing_areas: bool = True,
    ...
    area_names = {entry.name: f"{entry.name} ({world_names[brfld_path][0]})" for entry in bmscc.raw.layers[0].entries}
    ...
    for layer_name, actor_name, actor in brfld.all_actors():
        ...
        if not any(
            [details.is_door, details.is_pickup, details.is_elevator, details.is_usable, details.is_breakable_blob]
        ):
            continue
        ...
        if details.is_door:
            ...
            for room_name in details.rooms:
                definition = details.create_node_template(
                    "pickup", f"Pickup ({actor.sName})", node_data_for_area.get(room_name)
                )
            ...
            definition = details.create_node_template(
                "teleporter", f"Elevator ({actor.sName})", node_data_for_area.get(room_name)
            )
