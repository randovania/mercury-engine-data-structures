...
@pytest.mark.parametrize(
    ...
    (
        ...
        (
            "base::global::CRntVector<bool>",
            ["foo", True, 999],
            TypeError((0, TypeError("Expected bool; got str")), (2, TypeError("Expected bool; got int"))),
        ),
        # dictionary
        ...
        (
            ...
            TypeError(
                ("Keys", {1.0: TypeError("Expected str; got float"), 2.0: TypeError("Expected str; got float")}),
                ("Values", {1.0: TypeError("Expected float; got str"), "bar": TypeError("Expected float; got str")}),
            ),
        ),
    ),
)
